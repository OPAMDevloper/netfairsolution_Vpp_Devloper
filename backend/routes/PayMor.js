...
class PayMor {
  constructor() {
    ...
    this._PG_URL = "https://payin.paymor.in/PaymentGateway/api/seamless/txnReq";
    this._PGStatusCheck_URL = "https://payin.paymor.in/PaymentGateway/apis/seamless/txnStatus";
    // this._PGCancel_URL = "";
    // this._PGRefund_URL = "";
    this._mid; //Provided by PayMor (ex: 900000000000007)
    this._secretKey;
    this._saltKey;
