            ...
            <div className=" my-4 border-b border-gray-100 pb-4">
              ...
              <div class="mt-6">
                <ul class="mt-3">
                  <li>
                    <a
                      href={kycVerified ? "/your-link" : "javascript:void(0)"}
                      class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li>
                    <a
                      href={
                        kycVerified ? "/PaymentFormURL" : "javascript:void(0)"
                      }
                      class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all"
                    >
                  ...
                  <li>
                    <a
                      href={kycVerified ? "/Feedback" : "javascript:void(0)"}
                      class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all"
                    >
                      <img
                        src="help-desk.png"
              ...
              <div class="mt-6">
                <ul class="mt-3">
                  <li>
                    <a
                      href={kycVerified ? "/Profile" : "javascript:void(0)"}
                      class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
