  ...
  return (
    <div>
        ...
        <div className="p-6 w-1/2 h-screen overflow-y-auto bg-white z-20 fixed top-0 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
          ...
          {fullname ? fullname.charAt(0) : ""}
                ...
                <div className="text-center mt-4">
                  ...
                  <p className="text-xs text-black mt-1">{email}</p>
                </div>
      </div>
      <hr class="mt-6 border-gray-600" />
        ...
        <ul class="mt-3">
        <li>
            <a href={kycVerified ? '/your-link' : 'javascript:void(0)'}
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
          ...
          <li>
            <a href={kycVerified ? '/PaymentFormURL' : 'javascript:void(0)'}
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
            <img src="cards.png" className="w-[18px] h-[18px] mr-4" />

              <span>Payment Form link</span>
            </a>
          </li>
          <li>
            <a href={kycVerified ? '/your-link' : 'javascript:void(0)'}
          ...
          <li>
            <a href={kycVerified ? '/Feedback' : 'javascript:void(0)'}
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
      ...
      <div class="mt-6">
        ...
        <ul class="mt-3">
          <li>
            <a href={kycVerified ? '/Profile' : 'javascript:void(0)'}
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
                viewBox="0 0 512 512">
                <path
