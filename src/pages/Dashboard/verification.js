  ...
  const handleFormSubmission = async () => {
    ...
    try {
      const response = await axios.post(
        `${backendUrl}/api/verification/submit`,
        formData,
        {
          headers: {
      ...
      <div className="lg:ml-64">
        <div className="sm:w-[38rem] mx-auto my-10 overflow-hidden rounded-2xl bg-white shadow-lg sm:max-w-lg">
          <div className="bg-blue-800 px-10 py-10 text-center text-white">
            <p className="font-serif text-2xl font-semibold text-white tracking-wider">
              Submit your KYC
            </p>
            <div className="max-w-sm mx-auto px-4 font-[sans-serif]">
              <h4 className="text-sm text-white font-semibold">
                {step === 1
                  ? "1/5 : Step 1: About your business"
                  : step === 2
                  ? "2/5 : Step 2: More business details"
                  : step === 3
                  ? "3/5 : Step 3: Bank account details"
              ...
              <>
                <label className="block" htmlFor="category">
                  <p className="text-gray-600">
                    What is the category of your business?
                  </p>
                  <select
                ...
                {category && (
                  <label className="block" htmlFor="subCategory">
                    <p className="text-gray-600">
                      What sub-category is your business in?
                    </p>
                    <select
                      className="w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1"
                      value={subCategory}
                ...
                <label className="block" htmlFor="collectDonations">
                  <p className="text-gray-600">
                    Do you plan to collect donations?
                  </p>
                  <div className="flex items-center space-x-4">
                    <input
                      type="radio"
